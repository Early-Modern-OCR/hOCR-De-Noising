...
htmlhelp_basename = 'emop-controllerdoc'
...
latex_documents = [
  ('index', 'emop-controller.tex', u'emop-controller Documentation',
   u'Trey Dockendorf', 'manual'),
]
...
man_pages = [
    ('index', 'emop-controller', u'emop-controller Documentation',
     [u'Trey Dockendorf'], 1)
]
...
texinfo_documents = [
  ('index', 'emop-controller', u'emop-controller Documentation',
   u'Trey Dockendorf', 'emop-controller', 'One line description of project.',
   'Miscellaneous'),
]
